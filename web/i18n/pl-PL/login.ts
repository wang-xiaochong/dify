const translation = {
  ...
  welcome: 'Witaj w Hyseim, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej Hyseim, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na Hyseim',
  invalid: 'Link wygasł',
  explore: 'Odkryj Hyseim',
