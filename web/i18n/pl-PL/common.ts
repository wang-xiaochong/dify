const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto Hyseim',
    langGeniusAccountTip: 'Twoje konto Hyseim i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do Hyseim, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez Hyseim pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach Hyseim.',
  ...
  about: {
    ...
    nowAvailable: 'Hyseim {{version}} jest teraz dostępny.',
    latestAvailable: 'Hyseim {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
    overview: 'Przegląd',
