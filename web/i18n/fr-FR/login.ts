const translation = {
  ...
  welcome: 'Bienvenue sur Hyseim, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer Hyseim Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur Hyseim',
  invalid: 'Le lien a expiré',
  explore: 'Explorez Hyseim',
