const translation = {
  ...
  welcome: 'Willkommen bei Hyseim, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit Hyseim Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf Hyseim beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'Hyseim erkunden',
