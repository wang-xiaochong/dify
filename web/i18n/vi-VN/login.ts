const translation = {
  ...
  welcome: 'Chào mừng bạn đến với Hyseim, vui lòng đăng nhập để tiếp tục.',
  email: 'Địa chỉ Email',
  ...
  license: {
    tip: 'Trước khi bắt đầu Phiên bản Cộng đồng của Hyseim, hãy đọc',
    link: 'Giấy phép mã nguồn mở trên GitHub',
  },
  join: 'Tham gia',
  joinTipStart: 'Mời bạn tham gia',
  joinTipEnd: 'đội tại Hyseim',
  invalid: 'Liên kết đã hết hạn',
  explore: 'Khám phá Hyseim',
