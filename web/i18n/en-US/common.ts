const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Hyseim account',
    langGeniusAccountTip: 'Your Hyseim account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Hyseim to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Hyseim allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Hyseim\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Hyseim {{version}} is now available.',
    latestAvailable: 'Hyseim {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
