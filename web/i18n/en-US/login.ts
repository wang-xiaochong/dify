const translation = {
  ...
  welcome: 'Welcome to Hyseim, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Hyseim Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on Hyseim',
  invalid: 'The link has expired',
  explore: 'Explore Hyseim',
