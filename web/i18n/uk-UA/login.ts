const translation = {
  ...
  welcome: 'Ласкаво просимо до Hyseim, будь ласка, увійдіть, щоб продовжити.',
  ...
  license: {
    tip: 'Перед запуском Hyseim Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub',
    link: 'Ліцензія з відкритим кодом',
  },
  join: 'Приєднуйтесь',
  joinTipStart: 'Запрошуємо вас приєднатися',
  joinTipEnd: 'команда Hyseim',
  invalid: 'Посилання застаріло',
  explore: 'Досліджуйте Hyseim',
