...
es basados en LLM Function Calling o ReAct, y agregar herramientas preconstruidas o personalizadas para el agente. Hyseim proporciona más de 50 herramientas integradas para agentes de IA, como Búsqueda de Google, DELL·E, Difusión Estable y WolframAlpha.
...
**7. Backend como servicio**: 
  Todas las ofertas de Hyseim vienen con APIs correspondientes, por lo que podrías integrar Hyseim sin esfuerzo en tu propia lógica empresarial.
...
- **Nube </br>**
Hospedamos un servicio [Hyseim Cloud](https://dify.ai) para que cualquiera lo pruebe sin configuración. Proporciona todas las capacidades de la versión autoimplementada e incluye 200 llamadas gratuitas a GPT-4 en el plan sandbox.

- **Auto-alojamiento de Hyseim Community Edition</br>**
Pon rápidamente Hyseim en funcionamiento en tu entorno con esta [guía de inicio rápido](#quick-start).
Usa nuestra [documentación](https://docs.dify.ai) para más referencias e instrucciones más detalladas.

- **Hyseim para Empresas / Organizaciones</br>**
...
Dale estrella a Hyseim en GitHub y serás notificado instantáneamente de las nuevas versiones.
...
## Inicio Rápido
> Antes de instalar Hyseim, asegúrate de que tu máquina cumpla con los siguientes requisitos mínimos del sistema:
> 
>- CPU >= 2 núcleos
>- RAM >= 4GB
...
La forma más fácil de iniciar el servidor de Hyseim es ejecutar nuestro archivo [docker-compose.yml](docker/docker-compose.yaml). Antes de ejecutar el comando de instalación, asegúrate de que [Docker](https://docs.docker.com/get-docker/) y [Docker Compose](https://docs.docker.com/compose/install/) estén instalados en tu máquina:
...
Después de ejecutarlo, puedes acceder al panel de control de Hyseim en tu navegador en [http://localhost/install](http://localhost/install) y comenzar el proceso de inicialización.

> Si deseas contribuir a Hyseim o realizar desarrollo adicional, consulta nuestra [guía para implementar desde el código fuente](https://docs.dify.ai/getting-started/install-self-hosted/local-source-code)
...
Si deseas configurar una instalación altamente disponible, hay [Gráficos Helm](https://helm.sh/) contribuidos por la comunidad que permiten implementar Hyseim en Kubernetes.
...
Al mismo tiempo, considera apoyar a Hyseim compartiéndolo en redes sociales y en eventos y conferencias.


> Estamos buscando colaboradores para ayudar con la traducción de Hyseim a idiomas que no sean el mandarín o el inglés. Si estás interesado en ayudar, consulta el [README de i18n](https://github.com/langgenius/dify/blob/main/web/i18n/README.md) para obtener más información y déjanos un comentario en el canal `global-users` de nuestro [Servidor de Comunidad en Discord](https://discord.gg/8Tpq4AcN9c).
...
* [Reporte de problemas en GitHub](https://github.com/langgenius/dify/issues). Lo mejor para: errores que encuentres usando Hyseim.AI y propuestas de características. Consulta nuestra [Guía de contribución](https://github.com/langgenius/dify/blob/main/CONTRIBUTING.md).
* [Correo electrónico](mailto:support@dify.ai?subject=[GitHub]Questions%20About%20Dify). Lo mejor para: preguntas que tengas sobre el uso de Hyseim.AI.
...
Este repositorio está disponible bajo la [Licencia de Código Abierto de Hyseim](LICENSE), que es esencialmente Apache 2.0 con algunas restricciones adicionales.