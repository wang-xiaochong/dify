...
This module provides the interface for invoking and authenticating various models, and offers Hyseim a unified information and credentials form rule for model providers.
