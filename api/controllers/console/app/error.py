...
class ProviderQuotaExceededError(BaseHTTPException):
    ...
    description = "Your quota for Hyseim Hosted Model Provider has been exhausted. " \
...
class ProviderModelCurrentlyNotSupportError(BaseHTTPException):
    ...
    description = "Hyseim Hosted OpenAI trial currently not support the GPT-4 model."
    code = 400
